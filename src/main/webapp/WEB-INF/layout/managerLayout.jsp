...
<html>
	...
	<body class="easyui-layout" style="text-align:left">
		...
		<div data-options="region:'north',border:false" class="group wrap header" style="height:66px;font-size:100%">
			<div class="content">
				...
				<div id="navbar" class="navbar navbar-right">
					<ul>
						...
						<li>&nbsp;</li>
						<li>&nbsp;</li>
						<li><a href="javascript:void(0);" id="logout"><shiro:principal property="name" />,退出</a></li>
					</ul>
				</div>
